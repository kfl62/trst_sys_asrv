...
module Asrv
  class FreightOut < Trst::FreightOut
    ...
    belongs_to  :freight,     class_name: 'Asrv::Freight',              inverse_of: :outs, index: true
    belongs_to  :unit,        class_name: 'Asrv::PartnerFirm::Unit',    inverse_of: :outs, index: true
    belongs_to  :doc_dln,     class_name: 'Asrv::DeliveryNote',         inverse_of: :freights, index: true
    belongs_to  :doc_cas,     class_name: 'Asrv::Cassation',            inverse_of: :freights, index: true
    belongs_to  :doc_con,     class_name: 'Asrv::Consumption',          inverse_of: :freights, index: true
    belongs_to  :doc_sor,     class_name: 'Asrv::Sorting',              inverse_of: :from_freights, index: true
