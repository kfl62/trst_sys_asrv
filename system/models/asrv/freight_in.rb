...
module Asrv
  class FreightIn < Trst::FreightIn
    ...
    belongs_to  :freight,     class_name: 'Asrv::Freight',              inverse_of: :ins, index: true
    belongs_to  :unit,        class_name: 'Asrv::PartnerFirm::Unit',    inverse_of: :ins, index: true
    belongs_to  :doc_grn,     class_name: 'Asrv::Grn',                  inverse_of: :freights, index: true
    belongs_to  :doc_sor,     class_name: 'Asrv::Sorting',              inverse_of: :resl_freights, index: true
