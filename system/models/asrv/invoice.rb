...
module Asrv
  class Invoice < Trst::Invoice
    ...
    embeds_many :freights,     class_name: "Asrv::InvoiceFreight",      inverse_of: :doc_inv, cascade_callbacks: true
    has_many    :dlns,         class_name: "Asrv::DeliveryNote",        inverse_of: :doc_inv
    has_many    :grns,         class_name: "Asrv::Grn",                 inverse_of: :doc_inv
    has_many    :pyms,         class_name: "Asrv::Payment",             inverse_of: :doc_inv, dependent: :delete
    belongs_to  :client,       class_name: "Asrv::PartnerFirm",         inverse_of: :invs_client
    belongs_to  :client_d,     class_name: "Asrv::PartnerFirm::Person", inverse_of: :invs_client
    belongs_to  :signed_by,    class_name: "Asrv::User",                inverse_of: :invs
  ...
  class InvoiceFreight < Trst::Freight
    ...
    embedded_in :doc_inv,     class_name: "Asrv::Invoice",              inverse_of: :freights
  end # InvoiceFreight
end # Asrv
