...
module Asrv
  module Hmrs
    class Employee < Trst::Person
      ...
      embeds_one  :address,   class_name: 'Asrv::Hmrs::EmployeeAddress', cascade_callbacks: true
      embeds_one  :ilc,       class_name: 'Asrv::Hmrs::EmployeeIlc', cascade_callbacks: true
      embeds_many :addendums, class_name: 'Asrv::Hmrs::EmployeeAddendum', cascade_callbacks: true
    ...
    class EmployeeAddress < Trst::Address
      ...
      embedded_in :employee, class_name: 'Asrv::Hmrs::Employee', inverse_of: :address
    end # EmployeeAddress
    ...
    class EmployeeIlc
      ...
      embedded_in :employee, class_name: 'Asrv::Hmrs::Employee', inverse_of: :ilc
    end # EmployeeIlc
    ...
    class EmployeeAddendum
      ...
      embedded_in :employee, class_name: 'Asrv::Hmrs::Employee', inverse_of: :addendums
    end
  end # Hmrs
end # Asrv
