...
module Asrv
  class Sorting < Trst::Sorting
    ...
    has_many   :from_freights, class_name: "Asrv::FreightOut",          inverse_of: :doc_sor, dependent: :destroy
    has_many   :resl_freights, class_name: "Asrv::FreightIn",           inverse_of: :doc_sor, dependent: :destroy
    belongs_to :unit,          class_name: "Asrv::PartnerFirm::Unit",   inverse_of: :srts
    belongs_to :signed_by,     class_name: "Asrv::User",                inverse_of: :srts
