...
module Asrv
  class Grn < Trst::Grn
    ...
    has_many   :freights,     class_name: "Asrv::FreightIn",          inverse_of: :doc_grn, dependent: :destroy
    has_many   :dlns,         class_name: "Asrv::DeliveryNote",       inverse_of: :doc_grn
    belongs_to :supplr,       class_name: "Asrv::PartnerFirm",        inverse_of: :grns_supplr
    belongs_to :supplr_d,     class_name: "Asrv::PartnerFirm::Person",inverse_of: :grns_supplr
    belongs_to :doc_inv,      class_name: "Asrv::Invoice",            inverse_of: :grns
    belongs_to :unit,         class_name: "Asrv::PartnerFirm::Unit",  inverse_of: :grns
    belongs_to :signed_by,    class_name: "Asrv::User",               inverse_of: :grns
