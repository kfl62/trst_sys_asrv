        ...
        partner_firm: {
          updateDocAry: function(inpts) {
            ...
            inpts.filter(':checked').each(function() {
              return Asrv.desk.partner_firm.doc_ary.push(this.id);
            });
          ...
          inputs: function(inpts) {
            return inpts.filter(':checkbox').on('change', function() {
              return Asrv.desk.partner_firm.updateDocAry(inpts);
            });
          },
          ...
          init: function() {
            ...
            return $log('Asrv.desk.partner_firm.init() OK...');
          }
        }
      }
    });
    return Asrv.desk.partner_firm;
  });
